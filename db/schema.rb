...
ActiveRecord::Schema.define(version: 2020_01_26_122327) do

  create_table "puts", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.text "image", null: false
    t.string "name", null: false
    t.integer "category", default: 0, null: false
    t.date "bestby_date_y", null: false
    t.date "bestby_date_m", null: false
    ...
    t.index ["name"], name: "index_puts_on_name", length: 32
